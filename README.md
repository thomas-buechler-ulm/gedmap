...
This software is part of the article *Efficient short read mapping to a pangenome that is represented by a graph of ED strings* by Thomas Büchler, Jannik Olbrich and Enno Ohlebusch. (Published in OUP Bioinformatics: https://doi.org/10.1093/bioinformatics/btad320)
...
The comands mentioned above will download and generate the data needed to rerun the experiments. 
This includes the download of the GRCh37 genome, its variants and two different sets containing real reads. The links can be found in data/Makefile.
The sampled reads will be generated by program 'gedmap sample'. The commands can be found in exp/Makefile.
